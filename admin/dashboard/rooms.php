...
<body>
                        ...
                        <tr>
                            ...
                            <?php
                                ...
                                $formFields = [
                                    ...
                                    ['label' => 'Status', 'name' => 'status', 'type' => 'select', 'options' => getStatusOptions($row['status'])],
                                ];
    ...
    $formFields = [
        ...
        ['label' => 'Status', 'name' => 'status', 'type' => 'select', 'options' => getStatusOptions()],
    ];
    include('../../components/modal.php');
    ?>
...
function getStatusOptions($selectedStatus = null) {
    $options = '<option value="Available" ' . ($selectedStatus == 'Available' ? 'selected' : '') . '>Available</option>';
    $options .= '<option value="Occupied" ' . ($selectedStatus == 'Occupied' ? 'selected' : '') . '>Occupied</option>';
    return $options;
}
?>